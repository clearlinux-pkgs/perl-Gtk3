...
%prep
%setup -q -n Gtk3-0.037
cd %{_builddir}/Gtk3-0.037
...
cp %{_builddir}/Gtk3-0.037/LICENSE %{buildroot}/usr/share/package-licenses/perl-Gtk3/9b07aad54a8e378c05f9c314cd48b32fdbf5f02d
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.2/Gtk3.pm
